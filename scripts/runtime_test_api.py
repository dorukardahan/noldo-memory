...
def run(args):
    ...
    api._embedder = None if args.lexical_comparison or args.evidence_check or args.optional_tools else RecordedEmbedder()
    ...
    try:
        ...
        script = ('scripts/check_openclaw_optional_tools.mjs' if args.optional_tools else
                  'scripts/check_openclaw_evidence.mjs' if args.evidence_check else
                  'scripts/compare_openclaw_native.mjs' if args.lexical_comparison else
...
if __name__ == '__main__':
    ...
    parser.add_argument('--optional-tools', action='store_true', help='Run native tool/schema/HTTP checks without models.')
    parser.add_argument('--evidence-check', action='store_true', help='Check native preprocessing evidence without models or embeddings.')
