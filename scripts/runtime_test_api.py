...
def run(args):
    ...
    api._embedder = None if args.lexical_comparison or args.evidence_check else RecordedEmbedder()
    ...
    try:
        ...
        script = ('scripts/check_openclaw_evidence.mjs' if args.evidence_check else
