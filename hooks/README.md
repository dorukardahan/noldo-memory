...
| `bootstrap-context` | `agent:bootstrap` | Recalls session-scoped memories first, then workspace-durable lessons/decisions, injects `SESSION_CONTEXT` | `POST /v1/recall` |
