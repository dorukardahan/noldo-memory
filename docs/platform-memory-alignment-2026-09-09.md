...
Follow-up: [Gateway application attempts, short-event capture fix and official-install state preflight, 2026-09-13](openclaw-gateway-attempts-2026-09-13.md), following the [lifecycle and temporal tool contract check](openclaw-lifecycle-and-time-2026-09-13.md). Model-free capture improved; both new application attempts failed before model execution. A subsequent official npm install and model-free Gateway catalog query passed the state trust gate. Earlier real model failures remain open.
