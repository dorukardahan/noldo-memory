...
class Config:
    ...
    # Reranker (cross-encoder or hosted API)
    ...
    # Hosted API reranker (used instead of local cross-encoder when available)
    reranker_api_enabled: bool = False
    reranker_api_key: str = ""
    reranker_api_key_file: str = str(Path.home() / ".openrouter_key")
...
def load_config(config_path: Optional[str] = None) -> Config:
    ...
    Environment variables (all optional except OPENROUTER_API_KEY):
        ...
        AGENT_MEMORY_RERANKER_API_ENABLED
        AGENT_MEMORY_RERANKER_API_KEY
        AGENT_MEMORY_RERANKER_API_KEY_FILE
